                  ...
                  <div class="mb-3">
                    ...
                    <div class="my-5">
                        <div class="row d-flex justify-content-center">
                            <button type="button" class="btn btn-outline-primary m-1 col-5">Sou cliente</button>
                            <button type="button" class="btn btn-outline-primary m-1 col-5">Sou estabelecimento</button>
                        </div>
                    </div>
